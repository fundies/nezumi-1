...
#ifdef HAVE_STDIO_H
SDL_DYNAPI_PROC(SDL_RWops*,SDL_RWFromFP,(FILE *a, SDL_nez_b32_t b),(a,b),return)
#else
SDL_DYNAPI_PROC(SDL_RWops*,SDL_RWFromFP,(void *a, SDL_nez_b32_t b),(a,b),return)
#endif
...
SDL_DYNAPI_PROC(void,SDL_iPhoneSetEventPump,(SDL_nez_b32_t a),(a),)
#endif
...
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_AtomicTryLock,(SDL_SpinLock *a),(a),return)
SDL_DYNAPI_PROC(void,SDL_AtomicLock,(SDL_SpinLock *a),(a),)
SDL_DYNAPI_PROC(void,SDL_AtomicUnlock,(SDL_SpinLock *a),(a),)
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_AtomicCAS,(SDL_atomic_t *a, int b, int c),(a,b,c),return)
...
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_AtomicCASPtr,(void **a, void *b, void *c),(a,b,c),return)
...
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_HasClipboardText,(void),(),return)
SDL_DYNAPI_PROC(int,SDL_GetCPUCount,(void),(),return)
SDL_DYNAPI_PROC(int,SDL_GetCPUCacheLineSize,(void),(),return)
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_HasRDTSC,(void),(),return)
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_HasAltiVec,(void),(),return)
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_HasMMX,(void),(),return)
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_Has3DNow,(void),(),return)
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_HasSSE,(void),(),return)
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_HasSSE2,(void),(),return)
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_HasSSE3,(void),(),return)
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_HasSSE41,(void),(),return)
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_HasSSE42,(void),(),return)
...
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_HasEvent,(Uint32 a),(a),return)
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_HasEvents,(Uint32 a, Uint32 b),(a,b),return)
...
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_GetEventFilter,(SDL_EventFilter *a, void **b),(a,b),return)
...
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_IsGameController,(int a),(a),return)
...
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_GameControllerGetAttached,(SDL_GameController *a),(a),return)
...
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_SetHintWithPriority,(const char *a, const char *b, SDL_HintPriority c),(a,b,c),return)
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_SetHint,(const char *a, const char *b),(a,b),return)
...
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_JoystickGetAttached,(SDL_Joystick *a),(a),return)
...
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_IsTextInputActive,(void),(),return)
SDL_DYNAPI_PROC(void,SDL_StopTextInput,(void),(),)
SDL_DYNAPI_PROC(void,SDL_SetTextInputRect,(SDL_Rect *a),(a),)
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_HasScreenKeyboardSupport,(void),(),return)
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_IsScreenKeyboardShown,(SDL_Window *a),(a),return)
...
SDL_DYNAPI_PROC(int,SDL_SetRelativeMouseMode,(SDL_nez_b32_t a),(a),return)
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_GetRelativeMouseMode,(void),(),return)
...
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_PixelFormatEnumToMasks,(Uint32 a, int *b, Uint32 *c, Uint32 *d, Uint32 *e, Uint32 *f),(a,b,c,d,e,f),return)
...
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_HasIntersection,(const SDL_Rect *a, const SDL_Rect *b),(a,b),return)
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_IntersectRect,(const SDL_Rect *a, const SDL_Rect *b, SDL_Rect *c),(a,b,c),return)
SDL_DYNAPI_PROC(void,SDL_UnionRect,(const SDL_Rect *a, const SDL_Rect *b, SDL_Rect *c),(a,b,c),)
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_EnclosePoints,(const SDL_Point *a, int b, const SDL_Rect *c, SDL_Rect *d),(a,b,c,d),return)
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_IntersectRectAndLine,(const SDL_Rect *a, int *b, int *c, int *d, int *e),(a,b,c,d,e),return)
...
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_RenderTargetSupported,(SDL_Renderer *a),(a),return)
...
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_IsShapedWindow,(const SDL_Window *a),(a),return)
...
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_SetClipRect,(SDL_Surface *a, const SDL_Rect *b),(a,b),return)
...
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_GetWindowWMInfo,(SDL_Window *a, SDL_SysWMinfo *b),(a,b),return)
...
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_RemoveTimer,(SDL_TimerID a),(a),return)
...
SDL_DYNAPI_PROC(void,SDL_SetWindowBordered,(SDL_Window *a, SDL_nez_b32_t b),(a,b),)
...
SDL_DYNAPI_PROC(void,SDL_SetWindowGrab,(SDL_Window *a, SDL_nez_b32_t b),(a,b),)
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_GetWindowGrab,(SDL_Window *a),(a),return)
...
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_IsScreenSaverEnabled,(void),(),return)
...
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_GL_ExtensionSupported,(const char *a),(a),return)
...
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_HasAVX,(void),(),return)
SDL_DYNAPI_PROC(SDL_AssertionHandler,SDL_GetDefaultAssertionHandler,(void),(),return)
SDL_DYNAPI_PROC(SDL_AssertionHandler,SDL_GetAssertionHandler,(void **a),(a),return)
#ifdef __WIN32__
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_DXGIGetOutputInfo,(int a,int *b, int *c),(a,b,c),return)
#endif
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_RenderIsClipEnabled,(SDL_Renderer *a),(a),return)
#ifdef __WINRT__
...
SDL_DYNAPI_PROC(int,SDL_CaptureMouse,(SDL_nez_b32_t a),(a),return)
SDL_DYNAPI_PROC(int,SDL_SetWindowHitTest,(SDL_Window *a, SDL_HitTest b, void *c),(a,b,c),return)
SDL_DYNAPI_PROC(Uint32,SDL_GetGlobalMouseState,(int *a, int *b),(a,b),return)
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_HasAVX2,(void),(),return)
...
SDL_DYNAPI_PROC(int,SDL_RenderSetIntegerScale,(SDL_Renderer *a, SDL_nez_b32_t b),(a,b),return)
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_RenderGetIntegerScale,(SDL_Renderer *a),(a),return)
SDL_DYNAPI_PROC(Uint32,SDL_DequeueAudio,(SDL_AudioDeviceID a, void *b, Uint32 c),(a,b,c),return)
SDL_DYNAPI_PROC(void,SDL_SetWindowResizable,(SDL_Window *a, SDL_nez_b32_t b),(a,b),)
...
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_GetHintnez_b32_tean,(const char *a, SDL_nez_b32_t b),(a,b),return)
...
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_HasNEON,(void),(),return)
...
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_JoystickGetAxisInitialState,(SDL_Joystick *a, int b, Sint16 *c),(a,b,c),return)
...
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_Vulkan_GetInstanceExtensions,(SDL_Window *a, unsigned int *b, const char **c),(a,b,c),return)
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_Vulkan_CreateSurface,(SDL_Window *a, VkInstance b, VkSurfaceKHR *c),(a,b,c),return)
...
#endif
#ifdef __ANDROID__
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_IsAndroidTV,(void),(),return)
#endif
...
#endif
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_HasAVX512F,(void),(),return)
#ifdef __ANDROID__
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_IsChromebook,(void),(),return)
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_IsDeXMode,(void),(),return)
...
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_IsTablet,(void),(),return)
SDL_DYNAPI_PROC(SDL_DisplayOrientation,SDL_GetDisplayOrientation,(int a),(a),return)
SDL_DYNAPI_PROC(SDL_nez_b32_t,SDL_HasColorKey,(SDL_Surface *a),(a),return)
