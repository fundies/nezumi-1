...
extern int Android_AddJoystick(int device_id, const char *name, const char *desc, int vendor_id, int product_id, SDL_nez_b32_t is_accelerometer, int button_mask, int naxes, int nhats, int nballs);
...
typedef struct SDL_joylist_item
{
    ...
    SDL_nez_b32_t is_accelerometer;
