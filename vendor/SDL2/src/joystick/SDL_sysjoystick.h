...
typedef struct _SDL_JoystickAxisInfo
{
    ...
    SDL_nez_b32_t has_initial_value; /* Whether we've seen a value on the axis yet */
    SDL_nez_b32_t sent_initial_value; /* Whether we've sent the initial axis value */
...
struct _SDL_Joystick
{
    ...
    SDL_nez_b32_t attached;
    SDL_nez_b32_t is_game_controller;
    SDL_nez_b32_t delayed_guide_button; /* SDL_TRUE if this device has the guide button event delayed */
    SDL_nez_b32_t force_recentering; /* SDL_TRUE if this device needs to have its state reset to 0 */
