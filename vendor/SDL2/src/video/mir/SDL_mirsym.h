...
SDL_MIR_SYM(nez_b32_t,mir_buffer_stream_get_graphics_region,(MirBufferStream *stream, MirGraphicsRegion *graphics_region))
...
SDL_MIR_SYM(nez_b32_t,mir_pointer_event_button_state,(MirPointerEvent const *event, MirPointerButton button))
...
SDL_MIR_SYM(nez_b32_t,mir_connection_is_valid,(MirConnection *connection))
...
SDL_MIR_SYM(nez_b32_t,mir_window_is_valid,(MirWindow *window))
...
SDL_MIR_SYM(nez_b32_t,mir_output_is_enabled,(MirOutput const* output))
...
SDL_MIR_SYM(nez_b32_t,mir_output_is_gamma_supported,(MirOutput const* output))
