...
SDL_X11_SYM(int,XChangePointerControl,(Display* a,nez_b32_t b,nez_b32_t c,int d,int e,int f),(a,b,c,d,e,f),return)
...
SDL_X11_SYM(nez_b32_t,XCheckIfEvent,(Display* a,XEvent *b,nez_b32_t (*c)(Display*,XEvent*,XPointer),XPointer d),(a,b,c,d),return)
...
SDL_X11_SYM(nez_b32_t,XFilterEvent,(XEvent *event,Window w),(event,w),return)
...
SDL_X11_SYM(int,XGetWindowProperty,(Display* a,Window b,Atom c,long d,long e,nez_b32_t f,Atom g,Atom* h,int* i,unsigned long* j,unsigned long *k,unsigned char **l),(a,b,c,d,e,f,g,h,i,j,k,l),return)
...
SDL_X11_SYM(int,XIfEvent,(Display* a,XEvent *b,nez_b32_t (*c)(Display*,XEvent*,XPointer),XPointer d),(a,b,c,d),return)
SDL_X11_SYM(int,XGrabKeyboard,(Display* a,Window b,nez_b32_t c,int d,int e,Time f),(a,b,c,d,e,f),return)
SDL_X11_SYM(int,XGrabPointer,(Display* a,Window b,nez_b32_t c,unsigned int d,int e,int f,Window g,Cursor h,Time i),(a,b,c,d,e,f,g,h,i),return)
...
SDL_X11_SYM(Atom,XInternAtom,(Display* a,_Xconst char* b,nez_b32_t c),(a,b,c),return)
...
SDL_X11_SYM(nez_b32_t,XQueryPointer,(Display* a,Window b,Window* c,Window* d,int* e,int* f,int* g,int* h,unsigned int* i),(a,b,c,d,e,f,g,h,i),return)
...
SDL_X11_SYM(Status,XSendEvent,(Display* a,Window b,nez_b32_t c,long d,XEvent* e),(a,b,c,d,e),return)
...
SDL_X11_SYM(int,XSync,(Display* a,nez_b32_t b),(a,b),return)
SDL_X11_SYM(int,XTextExtents,(XFontStruct* a,_Xconst char* b,int c,int* d,int* e,int* f,XCharStruct* g),(a,b,c,d,e,f,g),return)
SDL_X11_SYM(nez_b32_t,XTranslateCoordinates,(Display *a,Window b,Window c,int d,int e,int* f,int* g,Window* h),(a,b,c,d,e,f,g,h),return)
...
SDL_X11_SYM(nez_b32_t,XQueryExtension,(Display* a,_Xconst char* b,int* c,int* d,int* e),(a,b,c,d,e),return)
...
SDL_X11_SYM(Status,_XReply,(Display* a,xReply* b,int c,nez_b32_t d),(a,b,c,d),return)
SDL_X11_SYM(unsigned long,_XSetLastRequestRead,(Display* a,xGenericReply* b),(a,b),return)
SDL_X11_SYM(SDL_X11_XSynchronizeRetType,XSynchronize,(Display* a,nez_b32_t b),(a,b),return)
...
SDL_X11_SYM(nez_b32_t,XGetEventData,(Display* a,XGenericEventCookie* b),(a,b),return)
SDL_X11_SYM(void,XFreeEventData,(Display* a,XGenericEventCookie* b),(a,b),)    
#endif

#if SDL_VIDEO_DRIVER_X11_HAS_XKBKEYCODETOKEYSYM
SDL_X11_SYM(nez_b32_t,XkbQueryExtension,(Display* a,int * b,int * c,int * d,int * e, int *f),(a,b,c,d,e,f),return)
...
SDL_X11_SYM(void,XkbFreeClientMap,(XkbDescPtr a,unsigned int b, nez_b32_t c),(a,b,c),)
SDL_X11_SYM(void,XkbFreeKeyboard,(XkbDescPtr a,unsigned int b, nez_b32_t c),(a,b,c),)
SDL_X11_SYM(nez_b32_t,XkbSetDetectableAutoRepeat,(Display* a, nez_b32_t b, nez_b32_t* c),(a,b,c),return)
#endif
...
SDL_X11_SYM(Status,XShmPutImage,(Display* a,Drawable b,GC c,XImage* d,int e,int f,int g,int h,unsigned int i,unsigned int j,nez_b32_t k),(a,b,c,d,e,f,g,h,i,j,k),return)
...
SDL_X11_SYM(nez_b32_t,XShmQueryExtension,(Display* a),(a),return)
#endif
...
SDL_X11_SYM(nez_b32_t,XineramaIsActive,(Display *a),(a),return)
SDL_X11_SYM(nez_b32_t,XineramaQueryExtension,(Display *a,int *b,int *c),(a,b,c),return)
...
SDL_X11_SYM(int,XRRGetOutputProperty,(Display *dpy,RROutput output, Atom property, long offset, long length, nez_b32_t _delete, nez_b32_t pending, Atom req_type, Atom *actual_type, int *actual_format, unsigned long *nitems, unsigned long *bytes_after, unsigned char **prop),(dpy,output,property,offset,length, _delete, pending, req_type, actual_type, actual_format, nitems, bytes_after, prop),return)
...
SDL_X11_MODULE(XSS)
SDL_X11_SYM(nez_b32_t,XScreenSaverQueryExtension,(Display *dpy,int *event_base,int *error_base),(dpy,event_base,error_base),return)
...
SDL_X11_SYM(void,XScreenSaverSuspend,(Display *dpy,nez_b32_t suspend),(dpy,suspend),return)
#endif
...
SDL_X11_SYM(nez_b32_t,XF86VidModeGetAllModeLines,(Display *a,int b,int *c,XF86VidModeModeInfo ***d),(a,b,c,d),return)
SDL_X11_SYM(nez_b32_t,XF86VidModeGetModeLine,(Display *a,int b,int *c,XF86VidModeModeLine *d),(a,b,c,d),return)
SDL_X11_SYM(nez_b32_t,XF86VidModeGetViewPort,(Display *a,int b,int *c,int *d),(a,b,c,d),return)
SDL_X11_SYM(nez_b32_t,XF86VidModeQueryExtension,(Display *a,int *b,int *c),(a,b,c),return)
SDL_X11_SYM(nez_b32_t,XF86VidModeQueryVersion,(Display *a,int *b,int *c),(a,b,c),return)
SDL_X11_SYM(nez_b32_t,XF86VidModeSwitchToMode,(Display *a,int b,XF86VidModeModeInfo *c),(a,b,c),return)
SDL_X11_SYM(nez_b32_t,XF86VidModeLockModeSwitch,(Display *a,int b,int c),(a,b,c),return)
#endif
