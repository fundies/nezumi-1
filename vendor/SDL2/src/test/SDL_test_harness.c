...
*/
static int
SDLTest_RunTest(SDLTest_TestSuiteReference *testSuite, const SDLTest_TestCaseReference *testCase, Uint64 execKey, SDL_nez_b32_t forceTestRun)
{
    SDL_TimerID timer = 0;
...
int SDLTest_RunSuites(SDLTest_TestSuiteReference *testSuites[], const char *userRunSeed, Uint64 userExecKey, const char *filter, int testIterations)
{
	...
	SDL_nez_b32_t forceTestRun = SDL_FALSE;
    int testResult = 0;
    int runResult = 0;
